...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::text('french_name', null,  ['class' => 'form-control','placeholder'=>  trans("lang.food_name_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.food_name_help") }}
            </div>
        </div>
...
<!-- Price Field -->
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::textarea('french_description', null, ['class' => 'form-control','placeholder'=> trans("lang.food_description_placeholder")  ]) !!}
            <div class="form-text text-muted">{{ trans("lang.food_description_help") }}</div>
        </div>
    </div>
