...
<div class="form-group row col-6">
  {!! Form::label('name', 'French Name:', ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    <p>{!! $food->french_name !!}</p>
  </div>
</div>
...
<div class="form-group row col-6">
  {!! Form::label('description', 'French Description:', ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    <p>{!! $food->french_description !!}</p>
  </div>
</div>
