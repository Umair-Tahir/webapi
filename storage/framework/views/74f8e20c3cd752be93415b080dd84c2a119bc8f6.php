...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        <label for="name" class="col-3 control-label text-right">French Name</label>
        <div class="col-9">
            <?php echo Form::text('french_name', null,  ['class' => 'form-control','placeholder'=>  trans("lang.food_name_placeholder")]); ?>
...
<!-- Price Field -->
    ...
    <div class="form-group row ">
        <label for="name" class="col-3 control-label text-right">French Description</label>
        <div class="col-9">
            <?php echo Form::textarea('french_description', null, ['class' => 'form-control','placeholder'=> trans("lang.food_description_placeholder")  ]); ?>
...
<?php /**PATH C:\xampp\htdocs\webapi\resources\views/foods/fields.blade.php ENDPATH**/ ?>