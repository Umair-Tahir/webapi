...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cuisines.index')): ?>
    <li class="nav-item">
        <a class="nav-link <?php echo e(Request::is('cuisines*') ? 'active' : ''); ?>" href="<?php echo route('cuisines.index'); ?>"><?php if($icons): ?><i class="nav-icon fa fa-globe"></i><?php endif; ?><p><?php echo e(trans('lang.cuisine_plural')); ?></p></a>
    </li>
<?php endif; ?>
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('deliveryTypes.index')): ?>
    <li class="nav-item">
        <a class="nav-link <?php echo e(Request::is('deliveryTypes*') ? 'active' : ''); ?>" href="<?php echo route('deliveryTypes.index'); ?>"><?php if($icons): ?><i class="nav-icon fa fa-ship"></i><?php endif; ?><p><?php echo e(trans('lang.delivery_type_plural')); ?></p></a>
    </li>
<?php endif; ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('coupons.index')): ?>
    <li class="nav-item">
        <a class="nav-link <?php echo e(Request::is('coupons*') ? 'active' : ''); ?>" href="<?php echo route('coupons.index'); ?>"><?php if($icons): ?>
                <i class="nav-icon fa fa-ticket"></i><?php endif; ?><p><?php echo e(trans('lang.coupon_plural')); ?></p></a>
    </li>
<?php endif; ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('foods.index')): ?>
    <li class="nav-item has-treeview <?php echo e(Request::is('foods*') || Request::is('extra*') || Request::is('foodReviews*') || Request::is('nutrition*') ? 'menu-open' : ''); ?>">
        <a href="#" class="nav-link <?php echo e(Request::is('foods*') || Request::is('extra*') || Request::is('foodReviews*') || Request::is('nutrition*') ? 'active' : ''); ?>"> <?php if($icons): ?>
        ...
        <ul class="nav nav-treeview">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('extraGroups.index')): ?>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('extraGroups*') ? 'active' : ''); ?>" href="<?php echo route('extraGroups.index'); ?>"><?php if($icons): ?><i class="nav-icon fa fa-plus-square"></i><?php endif; ?><p><?php echo e(trans('lang.extra_group_plural')); ?></p></a>
                </li>
            <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('orders.index')): ?>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('orders*') ? 'active' : ''); ?>" href="<?php echo route('orders.index'); ?>"><?php if($icons): ?>
                            <i class="nav-icon fa fa-shopping-basket"></i><?php endif; ?><p><?php echo e(trans('lang.order_plural')); ?></p></a>
                </li>
            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\webapi\resources\views/layouts/menu.blade.php ENDPATH**/ ?>